...
export class OAuthController {
    ...
    async googleCallback(@Req() req: Request, @Res() res: Response, @Query() q: any) {
        return res.status(501).json({ message: 'Google callback not implemented', query: q });
    }
    ...
    async githubCallback(@Req() req: Request, @Res() res: Response, @Query() q: any) {
        return res.status(501).json({ message: 'GitHub callback not implemented', query: q });
    }
}
