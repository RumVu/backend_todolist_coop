...
export class Task {
  ...
  @ApiProperty({ example: '2023-12-31T23:59:59Z', description: 'Due date', required: false })
  dueDate?: Date;

  @ApiProperty({ example: 'uuid-group', description: 'The group this task belongs to' })
  groupId: string;

  @ApiProperty({ example: 'uuid-creator', description: 'The user who created this task' })
  creatorId: string;

  @ApiProperty({ example: 'uuid-assignee', description: 'The user assigned to this task', required: false })
  assigneeId?: string;
