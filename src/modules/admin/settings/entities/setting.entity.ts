...
export class SystemSetting {
  ...
  @ApiProperty({ example: 'auth.bcryptSaltRounds', description: 'System setting key' })
  key: string;

  @ApiProperty({ example: '10', description: 'String value of the setting' })
  value: string;

  @ApiProperty({ example: 'Rounds for password hashing', description: 'Setting description', required: false })
  description?: string;
